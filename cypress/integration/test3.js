import users from '../cypress/data/users';
import loginPage from '../support/pages/loginPage';
import productPage from '../support/pages/productPage';

describe('Test suite 3', function () {
  it.only('Verify a user can add products', function () {
    loginPage
      .open()
      .loginToTheApp(users.standardUser)
      .addToCardAllProducts()
      .verifyProductsQuantity('6');

    //productPage.productsLabel.should('contain', 'Product');
